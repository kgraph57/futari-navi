...
const SECTIONS = [
  {
    title: "1. 基本方針",
    content:
      "ふたりナビ（以下「当サイト」）は、利用者のプライバシーを尊重し、個人情報の保護に努めます。本ポリシーは、当サイトにおける個人情報の取り扱いについて説明するものです。",
  },
  {
    title: "2. 収集する情報",
    items: [
  ...
  },
  {
    title: "6. 情報の取り扱い",
    content:
      "当サイトは行政手続き・給付金に関する一般的な情報の提供を目的としています。利用者の個別の法律相談や税務相談に関する情報を収集・保存することはありません。サイト上で提供される情報は、専門家のアドバイスに代わるものではありません。",
  },
  {
    title: "7. セキュリティ",
    content:
  ...
  },
  {
    title: "9. 免責事項",
    items: [
      "当サイトの情報は一般的な行政手続き・制度の紹介を目的としており、個別の法律・税務アドバイスを行うものではありません",
